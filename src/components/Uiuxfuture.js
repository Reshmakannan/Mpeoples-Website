    ...
    <section className="uxfuture-main-section">
      <div className="uxfuture-main-container">
        ...
        <p className="uxfuture-main-description">
          Great design is more than visuals — it's about creating meaningful
          user experiences that drive engagement and business growth. At
          MPeoples, we combine user research, modern design tools, and strategic
          thinking to build intuitive digital products that users love.
        </p>
        ...
        <div className="uxfuture-card-grid">
          ...
          <div className="uxfuture-service-card uxfuture-card-bottom-left">
            <div className="uxfuture-card-header">
              <img
                ...
                className="uxfuture-card-icon"
              />
              <h3 className="uxfuture-card-title">
                Mobile-First &amp; Responsive Design
              </h3>
            </div>
            <p className="uxfuture-card-text">
              Our designs are optimized for all devices, ensuring a seamless
          ...
          <div className="uxfuture-service-card uxfuture-card-bottom-right">
            ...
            <p className="uxfuture-card-text">
              Through user testing and feedback analysis, we continuously refine
              the design to improve usability, engagement, and performance.
            </p>
          </div>
        </div>
      </div>
