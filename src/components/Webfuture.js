    ...
    <section className="webfuture-main-section">
      <div className="webfuture-main-container">
        ...
        <p className="webfuture-main-description">
          Great websites are more than just code — they are powerful digital
          platforms that drive performance, engagement, and business growth. At
          MPeoples, we combine modern technologies, scalable architecture, and
          performance-driven development to build secure and high-performing
        ...
        <div className="webfuture-card-grid">
          ...
          <div className="webfuture-service-card webfuture-card-bottom-left">
            <div className="webfuture-card-header">
              <img
                ...
                className="webfuture-card-icon"
              />
              <h3 className="webfuture-card-title">
                Mobile-First &amp; Responsive Design
              </h3>
            </div>
            <p className="webfuture-card-text">
              Every website we build is optimized for all screen sizes,
              delivering a seamless experience across mobile, tablet, and
              desktop devices.
            </p>
          </div>
          ...
          <div className="webfuture-service-card webfuture-card-bottom-right">
            ...
            <p className="webfuture-card-text">
              We optimize websites for speed, reliability, and protection by
              implementing best practices in performance tuning, security
              standards, and scalable infrastructure.
            </p>
          </div>
        </div>
      </div>
