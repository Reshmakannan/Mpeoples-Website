    ...
    <footer className="footer">
      ...
      <div className="footer-top">
        ...
        <div className="footer-col">
          ...
          <h4 className="footer-col-heading" style={{ marginTop: "28px" }}>Our Product</h4>
          <ul>
            <li><a href="/">Look It</a></li>
            <li><a href="/">Makkal Nalkatti</a></li>
      ...
      <div className="footer-newsletter">
        <span className="footer-newsletter-label">Get the latest updates from MPeoples</span>
      ...
      <div className="footer-watermark">
        <span className="footer-watermark-text">MPeoples</span>
      </div>
