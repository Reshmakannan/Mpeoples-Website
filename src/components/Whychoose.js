...
const features = [
  {
    ...
    desc: "Visually engrossing designs that captivate audiences",
  },
  {
    icon: structuredIcon,
    title: "Structured Web Framework",
    desc: "Scalable architecture for seamless growth",
  },
  {
    icon: codingIcon,
    title: "Secure Coding Techniques",
    desc: "Robust defense against cyber threats",
  },
  {
    icon: protectionIcon,
    title: "Advanced Web Protection",
    desc: "Cutting-edge security measures for safety",
  },
  {
    icon: teamIcon,
    title: "Dedicated Team",
    desc: "Experts committed to client success",
  },
  {
    icon: resultIcon,
    title: "Result-Oriented Approach",
    desc: "Strategies for achieving desired outcomes",
  },
  {
    icon: supportIcon,
    title: "24/7 Email Support",
    desc: "Round-the-clock assistance for client convenience",
  },
  {
    icon: maintenanceIcon,
    title: "Maintenance Support",
    desc: "Reliable upkeep for website performance",
  },
  {
    icon: deliveryIcon,
    title: "On-time Delivery",
    desc: "Timely completion of web projects",
  },
  {
    icon: satisfactionIcon,
    title: "100% Client Satisfaction",
    desc: "Client fulfillment by exceeding expectations",
  },
];
...
const stats = [
  {
    percent: "88%",
    desc: "Of consumers trust a business more after visiting a professional website",
  },
  {
    percent: "91%",
    desc: "Check a company's website before making a purchase decision",
  },
  {
    percent: "67%",
    desc: "Are more likely to buy from mobile-optimized websites",
  },
  {
    percent: "53%",
    desc: "Leave a site if it takes longer than 3 seconds to load",
  },
  {
    percent: "78%",
    desc: "Judge business credibility based on website design",
  },
  {
    percent: "84%",
    desc: "Expect businesses to have an online presence in 2025",
  },
];
...
const values = [
  {
    icon: commitmentIcon,
    title: "Commitment",
    desc: "We don't stop until we reach our goals.",
  },
  {
    icon: excellenceIcon,
    title: "Excellence",
    desc: "We don't settle for less, as we have set our standards high.",
  },
  {
    icon: passionIcon,
    title: "Passion",
    desc: "We go beyond our comfort-zone to develop tools that promise enhanced customer empowerment.",
  },
  {
    icon: teamworkIcon,
    title: "Teamwork",
    desc: "We operate in an inclusive work environment with a diverse pool of talent.",
  },
  {
    icon: priorityIcon,
    title: "Priority",
    desc: "Customers are our top priority. Customer satisfaction is our goal.",
  },
];
...
const WhyChoose = () => {
  ...
  useEffect(() => {
    ...
    const onPageScroll = () => {
      ...
      const fullyInView =
        rect.top <= SNAP_THRESHOLD && rect.top >= -SNAP_THRESHOLD;
          ...
          <section className="why-slide values-section">
            <div className="values-inner">
              ...
              <h2 className="values-heading">
                Our values that inspire us to push forward everyday.
              </h2>
